...
class squirrel(models.Model):
    x = models.DecimalField(max_digits=1000,decimal_places=13,default=None,blank=True)
    y = models.DecimalField(max_digits=1000,decimal_places=13,default=None,blank=True)
